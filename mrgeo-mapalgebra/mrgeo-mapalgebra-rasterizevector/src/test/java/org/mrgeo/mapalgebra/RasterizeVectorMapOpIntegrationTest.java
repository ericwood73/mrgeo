...
public static void init() throws IOException
{
  ...
  {
    log.warn("***RasterizeVectorMapOpIntegrationTest TESTS SET TO GENERATE BASELINE IMAGES ONLY***");
  }

  testUtils = new MapOpTestUtils(RasterizeVectorMapOpIntegrationTest.class);
